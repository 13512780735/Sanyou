 ...
 * 燈源3-3
 */
public class Device03Activity extends Container implements RadioGroup.OnCheckedChangeListener, PullToRefreshBase.OnRefreshListener2<ScrollView> {
    /**
     * 燈光亮度
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device03);
