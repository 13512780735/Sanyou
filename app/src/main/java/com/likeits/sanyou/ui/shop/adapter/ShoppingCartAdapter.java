package com.likeits.sanyou.ui.shop.adapter;
...
public class ShoppingCartAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String attribute = shoppingCartBean.getGoods_introduct();
        ...
        if ("1".equals(role)) {
            holder.tvCommodityPrice.setText("¥ " + shoppingCartBean.getMoney_need() + "");
        }else {
            holder.tvCommodityPrice.setText("¥ " + shoppingCartBean.getMoney_vip() + "");
        }
        holder.tvCommodityNum.setText(" X" + shoppingCartBean.getGoods_num() + "");
        holder.tvCommodityShowNum.setText(shoppingCartBean.getGoods_num() + "");
        // ImageLoader.getInstance().displayImage(shoppingCartBean.getImageUrl(),holder.ivShowPic);
        holder.ivShowPic.setImageResource(R.mipmap.shop_test01);
        //单选框按钮
    ...
    class ViewHolder {
        ImageView ivShowPic;
        TextView tvCommodityName, tvCommodityAttr, tvCommodityPrice, tvCommodityNum, tvCommodityShowNum, ivSub, ivAdd, tvCommodityDelete;
        CheckBox ckOneChose;
        LinearLayout rlEdit, rlEdit01;
        ...
        public ViewHolder(View itemView) {
            ...
            tvCommodityDelete = (TextView) itemView.findViewById(R.id.tv_commodity_delete);
            rlEdit = (LinearLayout) itemView.findViewById(R.id.rl_edit);
            rlEdit01 = (LinearLayout) itemView.findViewById(R.id.rl_edit01);
